# Restart the News Shorts Pipeline dashboard/scheduler.
# Usage:
...
$TaskName = "NewsShortsPipeline"
$StartupCmdName = "NewsShortsPipeline.cmd"
...
function Start-AppForeground {
    ...
    Write-Host "Starting News Shorts Pipeline..."
...
function Start-AppBackground {
    ...
    $port = Get-AppPort
    Write-Host "Starting News Shorts Pipeline in background..."
